  ...
  <center>
    ...
    <form action="" method="post">
      ...
      <div class="textform">
        ...
        <br>
        <input class="inputform" type="text" name="nama_alatmusik" id="nama_alatmusik" required>
      </div>
      <br>
      <div class="textform">
      ...
      <div class="textform">
        ...
        <br>
        <input class="inputform" type="text" name="asal" id="asal" required>
      </div>
      <br>
      <div class="textform">
        <label for="tahun_ditemukan">Tahun Ditemukan :</label>
        <br>
        <input class="inputform" type="text" name="tahun_ditemukan" id="tahun_ditemukan" required>
      </div>
      <br>
      <div class="textform">
        <label for="warna">Warna :</label>
        <br>
        <input class="inputform" type="text" name="warna" id="warna" required>
      </div>
      <br>
      <br>
