...
<body style="background-image:linear-gradient(to right, #4682B4, #00FFFF, #00FA9A);">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href=https://www.instagram.com/muhamadrizky_002>Instagram </a> </li> </ul> <a class="btn btn-outline-primary my-2 my-sm-0" href="php/login.php" role="button" style="font-weight:bold; color: black;">Login</a>
        </div>
    </nav>
    ...
    <div class="" style="background-color:#4682B4; width: 1700px; padding: 20px;">
        <p style="text-align: center; font-weight:bold; font-size:x-large; ">Muhamad Rizky &copy; 2021 | 203040043</p>
    </div>
</body>
